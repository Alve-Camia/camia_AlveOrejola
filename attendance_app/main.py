...
def read_attendance_input():
    ...
    attendace_creation_results = attendance_service.process_attendance_creation(
    ...
    if attendace_creation_results["error_status"]:
        display_warning(
            attendace_creation_results["error_type"],
            attendace_creation_results["error_message"]
        )
        return
    
    display_info("Info", "Attendance has been successfully made.\nTo look for the attendance, go to the attendance dashboard.")
...
menu_frame_attendance_button = button_constructor(teacher_frame, "Attendance Dashboard", "NORMAL", "TButton", show_dashboard_frame)
